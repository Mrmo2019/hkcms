        ...
        <div class="col-xs-12 col-sm-8 col-md-9" id="rightBox">
            ...
            <div class="col-sm-12 col-md-12 pad">
                ...
                <div class="productList">
                    ...
                    {hkcms:content action="lists" catid="$catid"  order="id DESC" num="10" page="$page"}
                    {volist name="data" id="vo"}
                        <div class="col-xs-6 col-sm-4 col-md-3 col-mm-6 productImg">
                            <a title="PRO-001" href='{$vo['url']}'>
                                ...
                                <img src="{$vo['thumb']}" alt="{$vo['title']}" style="width: 180px;height: 150px" />
                            </a>
                            <a class="productTitle" href="{$vo['url']}" title="{$vo['title']}">
                                {$vo['title']}
                            </a>
                        </div>
                    {/volist}
